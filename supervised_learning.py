...
# Define paths
positive_dir = r'C:\Users\visha\Desktop\crack_project\METU\Positive'  # Update with actual path
negative_dir = r'C:\Users\visha\Desktop\crack_project\METU\Negative'  # Update with actual path
results_dir = 'C:/Users/visha/Desktop/crack_project/supervised_results'
...
def main():
    ...
    for model_name, base_model in models.items():
        ...
        metrics, history = train_and_evaluate(model, model_name, train_generator, val_generator, test_images,
                                              test_labels)
